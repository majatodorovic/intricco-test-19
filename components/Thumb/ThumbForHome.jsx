...
export const ThumbForHome = ({ slug, categoryId }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute bottom-6 left-5 z-[50] mt-2 flex w-[calc(100%-40px)] flex-col`}
      >
        <div className="relative flex items-start justify-between">
          <Link href={link} className="relative line-clamp-2 cursor-pointer">
            <h3
          ...
          <div className="flex items-center justify-start gap-[0.5rem] pt-1">
